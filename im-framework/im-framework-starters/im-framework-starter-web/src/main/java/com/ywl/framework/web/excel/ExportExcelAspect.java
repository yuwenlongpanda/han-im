package com.ywl.framework.web.excel;
...
import com.ywl.framework.common.model.PageDTO;
...
public class ExportExcelAspect {
    ...
    @Pointcut("@annotation(com.ywl.framework.web.excel.ExportExcel)")
    ...
    public Object around(ProceedingJoinPoint point) throws Throwable {
        ...
        if (rawType == IPage.class) {
            ...
            Assert.notNull(pageDTO, method.getName() + "接口返回值为page，入参对象必须继承com.ywl.edu.core.common.model.PageDTO");
